...
*/
(function(b){Craft.Updater=Garnish.Base.extend({$graphic:null,$status:null,$errorDetails:null,data:null,init:function(a){this.$graphic=b("#graphic");this.$status=b("#status");a&&a.handle?(this.data=a,this.postActionRequest("update/prepare")):this.showError(Craft.t("Unable to determine what to update."))},updateStatus:function(a){this.$status.html(a)},showError:function(a){this.updateStatus(a);this.$graphic.addClass("error")},postActionRequest:function(a){Craft.postActionRequest(a,{data:this.data},
b.proxy(function(a,c,b){if("success"==c&&a.alive)this.onSuccessResponse(a);else this.onErrorResponse(b)},this),{complete:b.noop})},onSuccessResponse:function(a){a.data&&(this.data=a.data);a.errorDetails&&(this.$errorDetails=a.errorDetails);a.nextStatus&&this.updateStatus(a.nextStatus);a.nextAction&&this.postActionRequest(a.nextAction);if(a.finished){var b=!1;a.rollBack&&(b=!0);this.onFinish(a.returnUrl,b)}},onErrorResponse:function(a){this.$graphic.addClass("error");a="<p>"+Craft.t("A fatal error has occurred:")+
